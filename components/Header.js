  ...
  const TopBar = () => (
    <div className="w-full bg-blue-900 text-white text-xs py-1 px-4 flex justify-between items-center">
      <div className="flex items-center gap-4">
        ...
        <span>Call: <a href="tel:15597034544" className="underline">1-559-703-4544</a></span>
        <span className="hidden sm:inline-block">| Crystalautosalvage@gmail.com</span>
      </div>
      <div className="flex items-center gap-4">
      ...
      <div className="md:hidden sticky top-0 z-50 bg-white border-b border-gray-100 pb-2">
        ...
        <div className="flex justify-center items-center py-2">
          <Link href="/" className="flex items-center space-x-3 group">
            <Image src="/images/home/utv-atv-parts-pro-logo.svg" alt="UTV & ATV Parts Pro Logo" width={180} height={52} className="transition-transform group-hover:scale-110" priority />
          </Link>
        </div>
